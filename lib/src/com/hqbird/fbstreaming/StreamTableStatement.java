...
public class StreamTableStatement implements StreamStatement {
    ...
    public StreamTableStatement(String tableName, StatementType statementType, Map<String, Object> keyValues, Map<String, Object> oldFieldValues, Map<String, Object> newFieldValues) {
        ...
        this.oldFieldValues = (oldFieldValues != null) ? oldFieldValues : new HashMap<String, Object>();
        this.newFieldValues = (newFieldValues != null) ? newFieldValues : new HashMap<String, Object>();
    }
